...
import pandas as pd
import timeit
from Algos.asai_performance import min_sub_mining_asai_memory
from Algos.valid_performance import min_sub_mining_memory
from exit_after import run_mining_memory_eval
...
def compare_occurence_list_size(log, log_name, strategy, strategy_name, timeout, artStart): 
    ...
    for k in k_stops:
        ...
        for rel_sup in min_sups:
            ...
            pd.DataFrame.from_dict(df_dicts).to_csv('.\\Eval_Res\\' + log_name  + '_'+ strategy_name +'_Pattern_Mining_Memory.csv')   
