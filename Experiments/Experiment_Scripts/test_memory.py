import pandas as pd
import timeit
from Algos.freqt import min_sub_mining_freqt_memory
from Algos.valid import min_sub_mining_memory
from Experiment_Scripts.exit_after import run_mining_memory_eval
...
def compare_occurence_list_size(
    ...
    for rel_sup in min_sups:
        ...
        pd.DataFrame.from_dict(df_dicts).to_csv(
            output_path + log_name + "_" + strategy_name + "_Pattern_Mining_Memory.csv"
        )